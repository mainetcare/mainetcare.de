...
window.Litepicker = litepicker__WEBPACK_IMPORTED_MODULE_2___default.a;
window.createPopper = _popperjs_core__WEBPACK_IMPORTED_MODULE_1__["createPopper"];
...
window.dropdown = function () {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      showpicker = _ref$showpicker === void 0 ? false : _ref$showpicker;
  ...
  return {
    ...
    toggleOverlay: function toggleOverlay(state) {
      // this.updatePopper();
      if (overlay) {
        window.dispatchEvent(new CustomEvent('overlay', {
          detail: state
        }));
      }
    },
    ...
    listen: function listen() {
      ...
      window.livewire.on('refreshCart', function () {
        _this2.close();
      });
    }
  };
...
window.overlay = function () {
  return {
    open: false,
    toggle: function toggle(customevent) {
...
window.toasthandler = function () {
  return {
    ...
    fire: function fire(id) {
      ...
      var notice = this.notices.find(function (notice) {
        return notice.id === id;
      });
      var dur = notice.dur ? notice.dur : 2000;
      this.show = true;
      this.visible.push(notice);
      var timeShown = dur * this.visible.length;
      setTimeout(function () {
        _this4.remove(id);
      }, timeShown);
    },
...
window.initpopper = function () {
  window.poppi = [];
  var els = document.querySelectorAll("[data-droptrig]");
  els.forEach(function (el) {
    var panel = el.querySelector("[data-panel]");

    if (panel) {
      var pop = Object(_popperjs_core__WEBPACK_IMPORTED_MODULE_1__["createPopper"])(el, panel, {
        modifiers: [{
          name: 'offset',
          options: {
            offset: [0, 8]
...
window.onload = function () {
  calcHeader();
  initpopper();
  var errori = document.querySelectorAll("#PageError [data-errormessage]");

  if (errori.length > 0) {
    errori.forEach(function (el) {
...
window.livewire.on('initpopper', function () {
  initpopper();
});
...
__webpack_require__(/*! /Users/mmai/data/valet/mainetcare/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/mmai/data/valet/mainetcare/resources/css/tailwind.css */"./resources/css/tailwind.css");
